...
## Overview
Wastewater surveillance captures SARS-CoV-2 signal from the entire community — including asymptomatic and untested individuals — making it a more complete indicator of infection dynamics than clinical case counts alone. This project builds a pipeline to estimate the effective reproduction number (Rₑ) directly from wastewater viral load data, using San Diego County's Point Loma treatment plant as a case study (April 2021 – July 2022).
...
4. Estimate Rₑ — applied to both wastewater-inferred and reported case counts using epyestim, with 95% credible intervals


## References
1. Alvarez et al. (2021). Computing the daily reproduction number of COVID-19 by inverting the renewal equation. PNAS, 118(50). https://doi.org/10.1073/pnas.2105112118
2. San Diego Wastewater Surveillance – SEARCH. https://searchcovid.info/dashboards/wastewater-surveillance/
